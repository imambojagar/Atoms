export const environment = {
  BaseURL: 'http://10.201.111.121:5000/api/', // 'http://localhost:5094/api/',
  //BaseURL: 'http://109.123.243.118:8000/api/', http://10.201.111.121:9293
  //BaseURL: 'https://atom-app.newtrack.solutions/api/', 
 /*  "email": "admin@example.com",
  "password": "S@Admin#123", */
  AttachmentURL:
    'http://109.123.243.118:8000/api/Files/DownloadFileFromShare?fileName=',
  production: false,
  appVersion: 'v8.1.7',
