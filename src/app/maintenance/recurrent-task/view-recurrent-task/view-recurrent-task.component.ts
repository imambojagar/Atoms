...
@Component({
  standalone: true,
  selector: 'app-view-recurrent-task',
  imports: [PrimengModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './view-recurrent-task.component.html',
  styleUrls: ['./edit-delete-recurrent-task.component.scss'],
})
export class ViewRecurrentTaskComponent implements OnChanges {
        ...
        if(this.edit_asset_id) { 
          ...
          /*   this.transactionHistory=new TransactionHistory();
            ...
            if (sucess == true) {
              ...
              console.log("addRecurrentForm", this.addRecurrentForm);
