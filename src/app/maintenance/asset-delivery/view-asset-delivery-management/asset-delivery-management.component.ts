...
@Component({
  selector: 'view-app-asset-delivery-management',
  templateUrl: './view-app-asset-delivery-management.component.html',
  styleUrls: ['./asset-delivery-management.component.scss']
})
export class ViewAssetDeliveryManagementComponent implements   OnChanges, OnDestroy {
