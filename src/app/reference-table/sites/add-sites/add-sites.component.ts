...
@Component({
  ...
  styleUrl: './add-sites.component.scss',
  providers: [TranslatePipe],
})
export class AddSitesComponent implements AfterViewInit {
  ...
  async Init() {
    ...
    await this.resolveWhenCallOneIsReady;
    await this.resolveNameLangLookupIsReady;
