...
@Component({
  standalone: true,
  selector: 'view-details-name-definition',
  imports: [PrimengModule, ReactiveFormsModule, TranslateModule, TrPipe, TransactionHistoryComponent],
  templateUrl: './view-details-name-definition.component.html',
  styleUrls: ['./view-details-name-definition.scss'],
  providers: [MessageService, ConfirmationService, DatePipe],
})
export class ViewDetailsNameDefinitionComponent implements OnChanges {
  ...
  constructor(
    ...
    private employeeService: EmployeeService, public datepipe: DatePipe
  ) {
