...
@Component({
  selector: 'app-edit-delete-model-definition',
  standalone: true,
  imports: [
    PrimengModule,
    CommonModule,
  ...
  templateUrl: './edit-delete-model-definition.component.html',
  styleUrl: './edit-delete-model-definition.component.scss',
})
export class EditDeleteModelDefinitionComponent implements OnChanges {
