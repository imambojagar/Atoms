...
import {
  buildForm,
  buildtDetailsForm,
} from '../add-edit-inventory/form-builder';

@Component({
  selector: 'app-view-asset-inventory',
  standalone: true,
  ...
  templateUrl: './view-asset-inventory.component.html',
  styleUrl: './view-asset-inventory.component.scss',
})
export class ViewAssetInventoryComponent implements OnChanges {
