...
@Component({
  standalone: true,
  selector: 'view-details-t-retirement',
  templateUrl: './view-details-t-retirement.component.html',
  styleUrls: ['./view-details-t-retirement.component.scss'],
...
export class ViewDetailsTRetirementComponent {
