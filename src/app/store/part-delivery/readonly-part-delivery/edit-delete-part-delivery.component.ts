...
@Component({
  selector: 'edit-delete-part-delivery',
  templateUrl: './edit-delete-part-delivery.component.html',
  styleUrls: ['./edit-delete-part-delivery.component.css'],
  providers: [MessageService, ConfirmationService],
})
export class EditDeletePartDeliveryComponent implements OnChanges {
