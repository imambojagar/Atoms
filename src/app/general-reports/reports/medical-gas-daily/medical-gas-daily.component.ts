...
@Component({
  selector: 'app-medical-gas-daily',
  templateUrl: './medical-gas-daily.component.html',
  styleUrls: ['./medical-gas-daily.component.scss'],
})
export class MedicalGasDailyComponent {
  ...
  ngOnInit() {
    ...
    this.report.loadFile('./assets/reports/MG_Daily Report.mrt');
  ...
  Search() {
    ...
    this.apiRoom.medicalGasDailyReport(filter).subscribe((res: any) => {
      if (res) {
        this.noData = false;
