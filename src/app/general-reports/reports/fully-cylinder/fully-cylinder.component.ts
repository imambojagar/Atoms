...
@Component({
  selector: 'app-fully-cylinder',
  templateUrl: './fully-cylinder.component.html',
  styleUrls: ['./fully-cylinder.component.scss'],
})
export class FullyCylinderComponent {
  ...
  ngOnInit() {
    ...
    this.report.loadFile('./assets/reports/FullCylinders.mrt');
  ...
  Search() {
    ...
    this.apiCylinders
      .getFullyCylindersReportData(filter)
      .subscribe((res: any) => {
        if (res) {
          this.noData = false;
